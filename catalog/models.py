...
class Request(models.Model):
    ...
    code_request = models.AutoField(primary_key=True)  # Код заявки

    def __str__(self):
        return f"Заявка {self.code_request} від {self.id_needy.pib_needy}"

class Service(models.Model):
    id_service = models.AutoField(primary_key=True)  # Первинний ключ
